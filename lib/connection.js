...
// CLASS
	 ...
	 *
	 * @typedef  {function(PoolConnection): void} CBsuccess
	 * @property {PoolConnection} con The **MySQL** `connection`
	 */
	 ...
	 * @property {Error} err An `error` object describing the failure
	 */
